...
1. Add-on is updated to at least `1.0.3` (`hassio_role: manager`).
...
If Ingress UI shows `404` in health/network sections while scan logs are successful, update to `1.0.3` or newer (Ingress API base path fix).
